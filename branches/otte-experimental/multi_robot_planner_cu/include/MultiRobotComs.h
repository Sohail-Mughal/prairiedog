...
class GlobalVariables
{
  public:
   ...
   bool recover_all_robot_data_from_buffer(char* buffer, int &index); // gets robot data out of the buffer, updates index, returns true if the planning iteration changes due to what was in the buffer
